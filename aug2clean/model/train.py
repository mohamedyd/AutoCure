...
from aug2clean.setup.detectors.detect_method import DATA_PATH, EXP_PATH
from aug2clean.dataset.preprocess import preprocess
from aug2clean.dataset.dataset import Dataset
from aug2clean.model.build_model import build_model
from aug2clean.model.hyperparams import get_hyperparams
from aug2clean.model.metrics import evaluate_model
from aug2clean.model.utils import create_results_path, store_results_csv, plot_learning_curves, ExperimentType, \
    ExperimentName
...
def train_model(data_df,
    ...
    plot_learning_curves(model.history_,
                         data_name,
...
if __name__ == '__main__':
    ...
    # experiment_type: aug2clean, ground_truth, other baselines
