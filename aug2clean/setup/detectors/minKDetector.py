...
import os
import pandas as pd
from aug2clean.setup.utils import store_detections
from aug2clean.setup.detectors.detect_method import DetectMethod, EXP_PATH
...
from aug2clean.model.utils import create_results_path, store_results_csv, ExperimentName, ExperimentType
...
def min_k(dataset_name, dirty_path, clean_path, detections_path, threshold=0.2):
    ...
    for detector_name in detectors_list:
        if detector_name.__str__() not in ['min_k', 'aug2clean']:
