...
from aug2clean.setup.detectors.raha.raha.correction import Correction as Raha_Correction
from aug2clean.setup.detectors.raha.raha.dataset import Dataset as Raha_Dataset
